            ...
            <form class=" mx-5 my-5" enctype="multipart/form-data" action="javascript:void(0);" id="frmdata">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" name="tag[]" type="checkbox" value="World" id="flexCheckDefault">
                        <label class="form-check-label" for="flexCheckDefault">World</label>
                    </div>
                    <input class="form-check-input" name="tag[]" type="checkbox" value="Information" id="flexCheckChecked">
                    <label class="form-check-label" for="flexCheckChecked">Information</label>
                    <div class="form-check">
                        <input class="form-check-input" name="tag[]" type="checkbox" value="Marketing" id="flexCheckDefault1">
                        <label class="form-check-label" for="flexCheckDefault1">Marketing</label>
                    </div>
                    <input class="form-check-input" name="tag[]" type="checkbox" value="SEO" id="flexCheckChecked1">
                    <label class="form-check-label" for="flexCheckChecked1">SEO</label>
