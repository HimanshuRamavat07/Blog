...
<?php if (isset($_GET['c_uid'])) { $id = $_GET['c_uid']; ?>
    <?php $category1 = new Blog();
            $category2 = $category1->catagoryRead($id); 
            $data = $category2->fetch_assoc();        
    ?>
    <div class="row">
        ...
        <div class="card-header" style="border-radius:10px ;">
            ...
            <form class=" mx-5 my-5"  action="javascript:void(0);" id="frmdata">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>" id="uid">
                    <input type="text" class="form-control" id="floatingTitle" name="title" value="<?php echo $data['cat_title']; ?>">
...
<?php if (isset($_GET['t_uid'])) { $id = $_GET['t_uid']; ?>
    <?php   $tag1 = new Blog();
            $tag2 = $tag1->tagRead($id);
            $data = $tag2->fetch_assoc();  
    ?>
<div class="row">
<div class="col-md-4"></div>
<div class="col-md-4 my-5">
